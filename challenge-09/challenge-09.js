...
chamado `callback`.
- Esse `callback` será uma função, 32748-que passaremos por parâmetro ao invocar
...
*/
var subtraction = calculator(10,15);
var multiplication = calculator(10,15);
var division = calculator(10,15);
var mod = calculator(10,15);
